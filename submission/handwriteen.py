...
@click.argument("sid" , type=str)
@click.option("-u" , "--user" , "user" , type=str, default="first_admin" , help="the user to login as")
@click.option("--fname" , "filename" , type=str , default="something.pdf" , help="the name of download file")
@click.option("-c" , "--comment" , "comment" , type=bool , default=False , help="download comment(default False)")
